...
@section('content')
    ...
    <div id="content" class="content">
        ...
        <div class="profile-container">
            ...
            @endif
            <div class="row">
                <form name="tipsFormEdit" method="POST" action="/tips/edit_submit/{{ $tips_details['id'] }}" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-md-2 control-label">Title</label>
                        <div class="col-md-10 {{ $errors->has('tips_title') ? 'has-error' : '' }}">
                            <input type="text" name="tips_title" id="tips_title" class="form-control" value="{{ $tips_details['tips_title'] }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10 {{ $errors->has('tips_desc') ? 'has-error' : '' }}">
                            <textarea name="tips_desc" id="tips_desc" class="form-control">{{ $tips_details['tips_desc'] }}</textarea>
                        </div>
