...
@section('content')
    ...
    <div id="content" class="content">
        ...
        <div class="profile-container">
            ...
            @endif
            <div class="row">
                <form name="tag_form" method="POST" action="/tags/tag-add-save" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-md-2 control-label">Tags</label>
                        <div class="col-md-6 {{ $errors->has('tags_name') ? 'has-error' : '' }}">
                            <input class="form-control" placeholder="Tags" type="text" name="tags_name" id="tags_name" value="{{ old('tags_name') }}">
                        </div>
