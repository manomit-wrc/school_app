...
@section('content')
    ...
    <div id="content" class="content">
        ...
        <div class="profile-container">
            ...
            @endif
            <div class="row">
                <form name="frmCategory" method="POST" action="/category/update/{{ $category->id }}" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                        ...
                        <div class="col-md-10 {{ $errors->has('p_id') ? 'has-error' : '' }}">
                            <select name="p_id" id="p_id" class="form-control">
                                ...
                                <option value="{{ $value['id'] }}" @if($category->id === $value['id'] && $category['p_id'] > 0) selected="selected" @endif>{{ $value['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10 {{ $errors->has('name') ? 'has-error' : '' }}">
                            <input class="form-control" name="name" id="name" placeholder="Category Name" type="text" value="{{ $category->name }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10 {{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea id="description" name="description" class="form-control" placeholder="Category description">{{ $category->description }}</textarea>
                        </div>
