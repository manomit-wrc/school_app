                        ...
                        <tbody>
                            @foreach($fetch_all_subject as $key => $value)
                                <tr class="odd gradeX">
                                    ...
                                    <td>{{ ucwords($value['course_details']['full_name']) }}</td>
                                    <td>
                                        ...
                                        <a title="Add Section" href="/subject/topic-add/{{$value['id']}}" class="btn btn-primary btn-sm"><i class="fa fa-calendar" aria-hidden="true"></i></a>  
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
