				...
				<div class="tab-pane fade active in" id="latest-post">
					<div class="height-sm" data-scrollbar="true">
						<ul class="media-list media-list-with-divider">
							...
							<li class="media media-lg">
								<a href="javascript:;" class="pull-left">
									<img class="media-object" src="storage/dashboard/assets/img/gallery/gallery-10.jpg" alt="" />
								</a>
								<div class="media-body">
							...
							<li class="media media-lg">
								<a href="javascript:;" class="pull-left">
									<img class="media-object" src="storage/dashboard/assets/img/gallery/gallery-7.jpg" alt="" />
								</a>
								<div class="media-body">
							...
							<li class="media media-lg">
								<a href="javascript:;" class="pull-left">
									<img class="media-object" src="storage/dashboard/assets/img/gallery/gallery-8.jpg" alt="" />
								</a>
								<div class="media-body">
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td class="hidden-sm">
										<a href="javascript:;">
											<img src="storage/dashboard/assets/img/product/product-2.png" alt="" />
										</a>
									</td>
									<td>
										<h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
								...
								<tr>
									...
									<td class="hidden-sm">
										<a href="javascript:;">
											<img src="storage/dashboard/assets/img/product/product-3.png" alt="" />
										</a>
									</td>
									<td>
										<h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
								...
								<tr>
									...
									<td class="hidden-sm">
										<a href="javascript:;">
											<img src="storage/dashboard/assets/img/product/product-4.png" alt="" />
										</a>
									</td>
									<td>
										<h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
								...
								<tr>
									...
									<td class="hidden-tablet hidden-phone">
										<a href="javascript:;">
											<img src="storage/dashboard/assets/img/product/product-5.png" alt="" />
										</a>
									</td>
									<td>
										<h6><a href="javascript:;">Nunc eleifend lorem eu velit eleifend, eget faucibus nibh placerat.</a></h6>
				...
				<div class="tab-pane fade" id="email">
					<div class="height-sm" data-scrollbar="true">
						<ul class="media-list media-list-with-divider">
							...
							<li class="media media-sm">
								<a href="javascript:;" class="pull-left">
									<img src="storage/dashboard/assets/img/user-2.jpg" alt="" class="media-object rounded-corner" />
								</a>
								<div class="media-body">
							...
							<li class="media media-sm">
								<a href="javascript:;" class="pull-left">
									<img src="storage/dashboard/assets/img/user-3.jpg" alt="" class="media-object rounded-corner" />
								</a>
								<div class="media-body">
							...
							<li class="media media-sm">
								<a href="javascript:;" class="pull-left">
									<img src="storage/dashboard/assets/img/user-4.jpg" alt="" class="media-object rounded-corner" />
								</a>
								<div class="media-body">
				...
				<div class="panel-body">
					<div class="height-sm" data-scrollbar="true">
						<ul class="media-list media-list-with-divider media-messaging">
							<li class="media media-sm">
								<a href="javascript:;" class="pull-left">
									<img src="storage/dashboard/assets/img/user-5.jpg" alt="" class="media-object rounded-corner" />
								</a>
								<div class="media-body">
							...
							<li class="media media-sm">
								<a href="javascript:;" class="pull-left">
									<img src="storage/dashboard/assets/img/user-6.jpg" alt="" class="media-object rounded-corner" />
								</a>
								<div class="media-body">
							...
							<li class="media media-sm">
								<a href="javascript:;" class="pull-left">
									<img src="storage/dashboard/assets/img/user-8.jpg" alt="" class="media-object rounded-corner" />
								</a>
								<div class="media-body">
							...
							<li class="media media-sm">
								<a href="javascript:;" class="pull-left">
									<img src="storage/dashboard/assets/img/user-7.jpg" alt="" class="media-object rounded-corner" />
								</a>
								<div class="media-body">
									<h5 class="media-heading">John Doe</h5>
