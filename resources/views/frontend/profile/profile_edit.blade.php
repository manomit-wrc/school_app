...
@section('content')
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Edit Profile Page</h1>
                    ...
                    <form name="profile_edit" method="POST" action="/profile_edit" enctype="multipart/form-data">
                                    ...
                                    <table class="table table-profile">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="first_name" value="{{Auth::guard('crypto')->user()->first_name}}"> 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="last_name" value="{{Auth::guard('crypto')->user()->last_name}}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="email" name="email" value="{{Auth::guard('crypto')->user()->email}}" readonly="">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="city" value="{{Auth::guard('crypto')->user()->city}}">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button id="submit" name="submit" type="submit" class="btn btn-primary" style="margin-left: 100px;">Update</button>
