...
@section('content')
    ...
    <div id="content" class="content">
        ...
        <div class="profile-container">
            ...
            @endif
            <div class="row">
                <form name="frmExam" method="POST" action="/exam/update/{{ $exam->id }}" class="form-horizontal" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label class="col-md-2 control-label">Code</label>
                        <div class="col-md-10 {{ $errors->has('code') ? 'has-error' : '' }}">
                            <input class="form-control" placeholder="Exam Code" type="text" name="code" id="code" value="{{ $exam->code }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10 {{ $errors->has('name') ? 'has-error' : '' }}">
                            <input class="form-control" placeholder="Exam Name" type="text" name="name" id="name" value="{{ $exam->name }}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-md-10 date {{ $errors->has('start_date') ? 'has-error' : '' }}" id="datepicker-disabled-past" data-date-format="dd-mm-yyyy" data-date-start-date="Date.default">
                            <input type="text" name="start_date" id="start_date" class="form-control" placeholder="Select Date" value="{{Carbon\Carbon::parse($exam->start_date)->format('d-m-Y')}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-md-10 date {{ $errors->has('end_date') ? 'has-error' : '' }}" id="datepicker-disabled-past" data-date-format="dd-mm-yyyy" data-date-start-date="Date.default">
                            <input type="text" name="end_date" id="end_date" class="form-control" placeholder="End Date" value="{{Carbon\Carbon::parse($exam->end_date)->format('d-m-Y')}}">
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        </div>
