...
<head>
    <meta charset="utf-8" />
    <title>One Click | Login Page</title>
...
<body class="pace-top">
    ...
    <div class="login-cover">
        <div class="login-cover-image"><img src="{{ url('storage/admin_dashboard/assets/img/login-bg/bg-1.jpg') }}" data-id="login-cover-image" alt="" /></div>
    ...
    <div id="page-container" class="fade">
        ...
        <ul class="login-bg-list clearfix">
            <li class="active"><a href="#" data-click="change-bg"><img src="{{ url('storage/admin_dashboard/assets/img/login-bg/bg-1.jpg') }}" alt="" /></a></li>
            <li><a href="#" data-click="change-bg"><img src="{{ url('storage/admin_dashboard/assets/img/login-bg/bg-2.jpg') }}" alt="" /></a></li>
            <li><a href="#" data-click="change-bg"><img src="{{ url('storage/admin_dashboard/assets/img/login-bg/bg-3.jpg') }}" alt="" /></a></li>
            <li><a href="#" data-click="change-bg"><img src="{{ url('storage/admin_dashboard/assets/img/login-bg/bg-4.jpg') }}" alt="" /></a></li>
            <li><a href="#" data-click="change-bg"><img src="{{ url('storage/admin_dashboard/assets/img/login-bg/bg-5.jpg') }}" alt="" /></a></li>
            <li><a href="#" data-click="change-bg"><img src="{{ url('storage/admin_dashboard/assets/img/login-bg/bg-6.jpg') }}" alt="" /></a></li>
        </ul>
    ...
    <!-- ================== END BASE JS ================== -->
    {!! Html::script('storage/admin_dashboard/assets/js/login-v2.demo.min.js') !!}
...
<!-- Mirrored from seantheme.com/color-admin-v3.0/admin/html/index_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Sep 2017 12:29:07 GMT -->
</html>
