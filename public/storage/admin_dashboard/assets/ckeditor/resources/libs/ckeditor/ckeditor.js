...
(function() {
            ...
            f = function(a, b, c, d) {
                ...
                if (f.type == CKEDITOR.NODE_TEXT) {
                    ...
                    if (j >= f.getChildCount()) {
                        ...
                        h = true
                    } else f = f.getChild(j).getPrevious();
                else {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        if (o.type == CKEDITOR.NODE_TEXT) {
                            ...
                            if (o && !(k = o.getPrevious())) g = o.getParent()
                        } else {
                        ...
                        if (o.type == CKEDITOR.NODE_TEXT)
                            if (CKEDITOR.tools.trim(o.substring(D)).length) r = true;
                                ...
                                r = !o.getLength();
                                if (D == o.getLength()) {
                                    if (!(k = o.getNext())) g = o.getParent()
                                } else L(o, D) && (g = o.getParent())
                            }
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var B, w, H = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                                br: 1
                            } : null),
                            C = null,
                            A = function(a) {
    ...
    (function() {
        ...
        function b(a, c, d, f) {
            ...
            if ((h = CKEDITOR.filter.instances[f.element.data("cke-filter")]) &&
                !h.check(c)) return b(a, c, d, f.remaining);c = new CKEDITOR.dom.range(f.element);c.selectNodeContents(f.element);c = c.createIterator();c.enlargeBr = a.enlargeBr;c.enforceRealBlocks = a.enforceRealBlocks;c.activeFilter = c.filter = h;a._.nestedEditable = {
                element: f.element,
                container: d,
                ...
                for (this._.nextNode = null; j;) {
                    ...
                    if (E) j.type == CKEDITOR.NODE_TEXT && f.test(j.getText()) &&
                        ...
                        if (CKEDITOR.dtd.$block[n] && j.getAttribute("contenteditable") == "false") {
                            ...
                            b(this, a, e);
                            break
                        } else if (j.isBlockBoundary(this.forceBrBreak && !v && {
                                br: 1
                            })) {
                            if (n == "br") E = 1;
                    ...
                    if (h && !u)
                        for (; !j.getNext(l) && !s;) {
                            n = j.getParent();
                            if (n.isBlockBoundary(this.forceBrBreak && !v && {
                                    br: 1
                                })) {
                                u = 1;
                                E = 0;
    ...
    (function() {
        function a(a, b, c, d, f) {
            ...
            for (e in b) {
                n = b[e];
                n = typeof n == "boolean" ? {} : typeof n == "function" ? {
                    match: n
                } : L(n);
        ...
        function y(a, b, d, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) {
                a: for (var x = a.elementCallbacks, h = 0, o = x.length, w; h < o; ++h)
                    if (w = x[h](b)) {
                        r = w;
                        break a
                    }if (r) return r
            ...
            if (f.doFilter) {
                a: {
                    x = b.name;
                    h = a._;a = h.allowedRules.elements[x];r = h.allowedRules.generic;x = h.disallowedRules.elements[x];h = h.disallowedRules.generic;o = f.skipRequired;w = {
                        valid: false,
                        validAttributes: {},
                        validClasses: {},
                        validStyles: {},
                ...
                if (!a.allStyles || a.hadInvalidStyle) {
                    ...
                    if (D.length) x.style = D.sort().join("; ")
                } else if (C) x.style = C;
    ...
    (function() {
        ...
        a.prototype = {
            ...
            addMany: function(a,
                c, f) {
                for (var d = [this.findIndex(c), 0], e = 0, l = a.length; e < l; e++) d.push({
                    value: a[e],
                    priority: c,
                    options: f
                });
                        ...
                        this.attachListener(a, "key", function(b) {
                            ...
                            if (c in k) {
                                ...
                                if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (f = b.getSelectedElement()) || (f = d(b))) {
                                    ...
                                    if ((i =
                                            h.block) && (l = i[c ? "getPrevious" : "getNext"](s)) && l.type == CKEDITOR.NODE_ELEMENT && l.is("table") && g[c ? "checkStartOfBlock" : "checkEndOfBlock"]()) {
                                        a.fire("saveSnapshot");
    ...
    */
    ...
    (function() {
        ...
        CKEDITOR.ui.button.prototype = {
            render: function(a, b) {
                ...
                } else if (f && (f = a.getCommand(f))) f.on("state", function() {
    ...
    (function() {
        function k(a) {
            ...
            } catch (g) {}(CKEDITOR.env.gecko || CKEDITOR.env.ie && "CSS1Compat" == d.document.$.compatMode) && this.attachListener(this, "keydown", function(a) {
                var b = a.data.getKeystroke();
                if (b == 33 || b == 34)
    ...
    CKEDITOR.plugins.add("scayt", {
        ...
        menuGenerator: function(a, c) {
            ...
            for (var f in b) - 1 == CKEDITOR.tools.indexOf(g, f.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || (e[f] = CKEDITOR.TRISTATE_OFF, "function" === typeof b[f].verification && !b[f].verification(a) && delete e[f], a.addCommand(f, {
                exec: b[f].exec
            }), a.addMenuItem(f, {
    ...
    CKEDITOR.plugins.add("wsc", {
        ...
        init: function(a) {
            ...
            a.addCommand("checkspell",
                new CKEDITOR.dialogCommand("checkspell")).modes = {
